...
#ifndef _GATB_CORE_BANK_IMPL_BANK_FASTA_ZSTD_HPP_
#define _GATB_CORE_BANK_IMPL_BANK_FASTA_ZSTD_HPP_
 ...
 */
class BankFastaZstd : public AbstractBank
{
public:
     ...
     */
    BankFastaZstd (const std::string& filename, bool output_fastq = false, bool output_gz = false);
    ...
    public:
         ...
         */
        Iterator (BankFastaZstd& ref, CommentMode_e commentMode = FULL);
...
class BankFastaZstdFactory : public IBankFactory
{
public:
...
#endif /* _GATB_CORE_BANK_IMPL_BANK_FASTA_ZSTD_HPP_ */
